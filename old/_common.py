...
with open(script_dir+'/data/offsets.pickle', 'rb') as f:
    offsets = pickle.load(f)

with open(script_dir+'/data/definition.pickle', 'rb') as f:
    definition = pickle.load(f)

with open(script_dir+'/data/addresses_match.pickle', 'rb') as f:
    address_match = pickle.load(f)
